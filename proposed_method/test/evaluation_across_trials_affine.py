...
def main(subject="takeuchi", registration='affine', icc_r = False):
    ...
    for electrode_place in ["original", "original2", "downleft5mm", "downleft10mm", "clockwise"]:
        ...
        for gesture in range(1,8):
            ...
            for trial1 in range(1,16):  # トライアル数
                if trial1 < 15:
                    for trial2 in range(trial1+1,16):
                        scalar = MinMaxScaler()
                        if electrode_place == "original":
                            ...
                            img_test = (scalar.fit_transform(original_trial_alignment_maps_without_interp_1sec[gesture-1][trial2-1].reshape(-1,1)).reshape(original_trial_alignment_maps_without_interp_1sec[gesture-1][trial2-1].shape)*255).astype(np.float32)
                        elif electrode_place == "original2":
                            img_ref = (scalar.fit_transform(original2_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].reshape(-1,1)).reshape(original2_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].shape)*255).astype(np.float32)
                            ...
                            img_ref = (scalar.fit_transform(downleft5mm_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].reshape(-1,1)).reshape(downleft5mm_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].shape)*255).astype(np.float32)
                            ...
                            img_ref = (scalar.fit_transform(downleft10mm_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].reshape(-1,1)).reshape(downleft10mm_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].shape)*255).astype(np.float32)
                            ...
                            img_ref = (scalar.fit_transform(clockwise_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].reshape(-1,1)).reshape(clockwise_trial_alignment_maps_without_interp_1sec[gesture-1][trial1-1].shape)*255).astype(np.float32)
            ...
            plt.title('across_trials_gesture' + str(gesture) + '_' + electrode_place)
            plt.rcParams['font.size'] = 58
            plt.grid()
            plt.savefig('line_plot_across_trials_' + subject + '_gesture' + str(gesture) + '_' + electrode_place + '.png')
        ...
        plt.rcParams['font.size'] = 58
        plt.grid()
        plt.savefig('line_plot_across_trials_' + subject + '_' + electrode_place + '.png')
    ...
    plt.rcParams['font.size'] = 58
    plt.grid()
    plt.savefig('line_plot_across_trials_' + subject + '_all.png')
