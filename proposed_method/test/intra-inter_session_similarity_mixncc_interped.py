...
# Settings
# -----------------------
DATA_DIR = "output/takeuchi2/EMG_map_array/wl_interped"
...
def warp_emg_8x8(emg, tx, ty, theta, sx, sy, shear):
    ...
    # 6×6 サブセット抽出
    return emg_new[50:300,50:300] #[1:7,1:7]
...
def mix_ncc(ref_img, mov_img, ref_grad_cache=None, alpha=0.1, beta=0.45, threshold=0.35, steepness=10.0):
    """
    目的関数: 輝度NCC × 勾配NCC
    """
    # ref_img = np.pad(ref_img, ((1,1),(1,1)))
    # mov_img = np.pad(mov_img, ((1,1),(1,1)))
