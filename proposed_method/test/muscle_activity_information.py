...
def main(feature_func, func_type=False, feature_name='ptp', muscle_activity_informations_measurere='gaussianfitting', preprocess=False, n_subjects=5, n_sessions=2, distance_results=True, kmeans32=False, kmeans42=False, kmeans43=False, kmeans52=False, kmeans53=False, kmeans54=False, normalized_kmeans2=False, normalized_kmeans3=False, normalized_kmeans4=False, normalized_kmeans5=False, xmeans=False, normalized_xmeans=False, hdbscan=False, normalized_hdbscan=False, features=False):
                    ...
                    for electrode_place in electrode_places:
                        ...
                        try:
                            ...
                            if kmeans32:
                                ...
                                muscle_activity_informations_kmeans32.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars}) # muscle_activity_informations_kmeans32.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'emg_data': emg_data, 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 42kmeansクラスタリング
                            if kmeans42:
                                results_df, summary_df = kmeans_clustering(features, k1=4, k2=2)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_kmeans42.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 43kmeansクラスタリング
                            if kmeans43:
                                results_df, summary_df = kmeans_clustering(features, k1=4, k2=3)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_kmeans43.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 52kmeansクラスタリング
                            if kmeans52:
                                results_df, summary_df = kmeans_clustering(features, k1=5, k2=2)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_kmeans52.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 53kmeansクラスタリング
                            if kmeans53:
                                results_df, summary_df = kmeans_clustering(features, k1=5, k2=3)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_kmeans53.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 54kmeansクラスタリング
                            if kmeans54:
                                results_df, summary_df = kmeans_clustering(features, k1=5, k2=4)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_kmeans54.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 2normalized_kmeansクラスタリング
                            if normalized_kmeans2:
                                results_df, summary_df = normalized_kmeans_clustering(features, k1=2)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_normalized_kmeans2.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 3normalized_kmeansクラスタリング
                            if normalized_kmeans3:
                                results_df, summary_df = normalized_kmeans_clustering(features, k1=3)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_normalized_kmeans3.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 4normalized_kmeansクラスタリング
                            if normalized_kmeans4:
                                results_df, summary_df = normalized_kmeans_clustering(features, k1=4)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_normalized_kmeans4.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 5normalized_kmeansクラスタリング
                            if normalized_kmeans5:
                                results_df, summary_df = normalized_kmeans_clustering(features, k1=5)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_normalized_kmeans5.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # xmeansクラスタリング
                            if xmeans:
                                results_df, summary_df = xmeans_clustering(features, kmax=5)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_xmeans.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # normalized_xmeansクラスタリング
                            if normalized_xmeans:
                                results_df, summary_df = normalized_xmeans_clustering(features, kmax=5)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_normalized_xmeans.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # hdbscanクラスタリング
                            if hdbscan:
                                results_df, summary_df = hdbscan_clustering(features, min_cluster_size=10)
                                virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                                muscle_activity_informations_hdbscan.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            ...
                            if kmeans42:
                                muscle_activity_informations_kmeans42.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if kmeans43:
                                muscle_activity_informations_kmeans43.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if kmeans52:
                                muscle_activity_informations_kmeans52.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if kmeans53:
                                muscle_activity_informations_kmeans53.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if kmeans54:
                                muscle_activity_informations_kmeans54.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if normalized_kmeans2:
                                muscle_activity_informations_normalized_kmeans2.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if normalized_kmeans3:
                                muscle_activity_informations_normalized_kmeans3.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if normalized_kmeans4:
                                muscle_activity_informations_normalized_kmeans4.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if normalized_kmeans5:
                                muscle_activity_informations_normalized_kmeans5.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if xmeans:
                                muscle_activity_informations_xmeans.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if normalized_xmeans:
                                muscle_activity_informations_normalized_xmeans.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            if hdbscan:
    ...
    if distance_results:
        ...
        if kmeans32:
            save_records_to_csv(muscle_activity_informations_kmeans32, out_path='output/vpolars/' + file_name_prefix + '_kmeans32.csv')
        if kmeans42:
            save_records_to_csv(muscle_activity_informations_kmeans42, out_path='output/vpolars/' + file_name_prefix + '_kmeans42.csv')
        if kmeans43:
            save_records_to_csv(muscle_activity_informations_kmeans43, out_path='output/vpolars/' + file_name_prefix + '_kmeans43.csv')
        if kmeans52:
            save_records_to_csv(muscle_activity_informations_kmeans52, out_path='output/vpolars/' + file_name_prefix + '_kmeans52.csv')
        if kmeans53:
            save_records_to_csv(muscle_activity_informations_kmeans53, out_path='output/vpolars/' + file_name_prefix + '_kmeans53.csv')
        if kmeans54:
            save_records_to_csv(muscle_activity_informations_kmeans54, out_path='output/vpolars/' + file_name_prefix + '_kmeans54.csv')
        if normalized_kmeans2:
            save_records_to_csv(muscle_activity_informations_normalized_kmeans2, out_path='output/vpolars/' + file_name_prefix + '_normalized_kmeans2.csv')
        if normalized_kmeans3:
            save_records_to_csv(muscle_activity_informations_normalized_kmeans3, out_path='output/vpolars/' + file_name_prefix + '_normalized_kmeans3.csv')
        if normalized_kmeans4:
            save_records_to_csv(muscle_activity_informations_normalized_kmeans4, out_path='output/vpolars/' + file_name_prefix + '_normalized_kmeans4.csv')
        if normalized_kmeans5:
            save_records_to_csv(muscle_activity_informations_normalized_kmeans5, out_path='output/vpolars/' + file_name_prefix + '_normalized_kmeans5.csv')
        if xmeans:
            save_records_to_csv(muscle_activity_informations_xmeans, out_path='output/vpolars/' + file_name_prefix + '_xmeans.csv')
        if normalized_xmeans:
            save_records_to_csv(muscle_activity_informations_normalized_xmeans, out_path='output/vpolars/' + file_name_prefix + '_normalized_xmeans.csv')
        if hdbscan:
