...
# ----- クラスタリング -----
# kmeansクラスタリング
def kmeans_clustering(features, k1=4):
    # 1. 特徴ベクトルを構築
...
def main(feature_func, func_type=False, feature_name='ptp'):
    print('pca_' + feature_name)
    # 分析
    preprosess = False #前処理を行うかどうか
    n_subjects = 5 #20
    n_sessions = 2

    muscle_activity_informations_kmeans2 = []
    muscle_activity_informations_kmeans3 = []
    muscle_activity_informations_kmeans4 = []
    muscle_activity_informations_kmeans5 = []
                ...
                try:
                    ...
                    for electrode_place in electrode_places:
                        ...
                        try:
                            ...
                            # 2kmeansクラスタリング
                            results_df, summary_df = kmeans_clustering(features, k1=2)
                            virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                            muscle_activity_informations_kmeans2.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars}) # muscle_activity_informations_kmeans32.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'emg_data': emg_data, 'virtual_bipolars': virtual_bipolars, 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 3kmeansクラスタリング
                            results_df, summary_df = kmeans_clustering(features, k1=3)
                            virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                            muscle_activity_informations_kmeans3.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 4kmeansクラスタリング
                            results_df, summary_df = kmeans_clustering(features, k1=4)
                            virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                            muscle_activity_informations_kmeans4.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # 5kmeansクラスタリング
                            results_df, summary_df = kmeans_clustering(features, k1=5)
                            virtual_bipolars, labels, center_direction, n_virtual_bipolars = get_virtual_bipolars(results_df, show_plot=False)
                            muscle_activity_informations_kmeans5.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': labels, 'center_direction': center_direction, 'n_virtual_bipolars': n_virtual_bipolars})
                            # # 53kmeansクラスタリング
                            ...
                            muscle_activity_informations_kmeans2.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0}) # muscle_activity_informations_kmeans32.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'emg_data': [], 'virtual_bipolars': [], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            muscle_activity_informations_kmeans3.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            muscle_activity_informations_kmeans4.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
                            muscle_activity_informations_kmeans5.append({'file_name': record_name, 'gesture': gesture, 'trial': trial, 'subject': i+1, 'session': j+1, 'electrode_place':electrode_place[1], 'labels': [], 'center_direction': [], 'n_virtual_bipolars': 0})
    ...
    file_name_prefix = 'test4_' + feature_name + '_pca'
    # csvファイルに保存
    csv_saver(muscle_activity_informations_kmeans2, file_name_prefix = file_name_prefix + '_kmeans2')
    csv_saver(muscle_activity_informations_kmeans3, file_name_prefix = file_name_prefix + '_kmeans3')
    csv_saver(muscle_activity_informations_kmeans4, file_name_prefix = file_name_prefix + '_kmeans4')
    csv_saver(muscle_activity_informations_kmeans5, file_name_prefix = file_name_prefix + '_kmeans5')
