...
# csvファイルに保存
csv_saver(muscle_activity_informations_kmeans32, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans32')
csv_saver(muscle_activity_informations_kmeans42, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans42')
csv_saver(muscle_activity_informations_kmeans43, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans43')
csv_saver(muscle_activity_informations_kmeans52, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans52')
csv_saver(muscle_activity_informations_kmeans53, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans53')
csv_saver(muscle_activity_informations_kmeans54, file_name_prefix = 'test3_medianfrequency_gaussianfitting/kmeans54')
csv_saver(muscle_activity_informations_normalized_kmeans2, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_kmeans2')
csv_saver(muscle_activity_informations_normalized_kmeans3, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_kmeans3')
csv_saver(muscle_activity_informations_normalized_kmeans4, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_kmeans4')
csv_saver(muscle_activity_informations_normalized_kmeans5, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_kmeans5')
csv_saver(muscle_activity_informations_xmeans, file_name_prefix = 'test3_medianfrequency_gaussianfitting/xmeans')
csv_saver(muscle_activity_informations_normalized_xmeans, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_xmeans')
csv_saver(muscle_activity_informations_hdbscan, file_name_prefix = 'test3_medianfrequency_gaussianfitting/hdbscan')
csv_saver(muscle_activity_informations_normalized_hdbscan, file_name_prefix = 'test3_medianfrequency_gaussianfitting/normalized_hdbscan')
