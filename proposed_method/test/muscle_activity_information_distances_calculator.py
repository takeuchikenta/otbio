...
muscle_activity_information_gaussianfitting_ptp.run()
muscle_activity_information_gaussianfitting_rms.run()
muscle_activity_information_gaussianfitting_zc.run()
muscle_activity_information_gaussianfitting_waveformlength.run()
muscle_activity_information_gaussianfitting_meanfrequency.run()
muscle_activity_information_gaussianfitting_medianfrequency.run()
muscle_activity_information_gaussianfitting_peakfrequency.run()
muscle_activity_information_gaussianfitting_spectralentropy.run()
