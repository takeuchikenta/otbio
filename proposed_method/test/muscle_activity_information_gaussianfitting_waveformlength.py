...
if __name__ == "__main__":
                ...
                try:
                    ...
                    for electrode_place in electrode_places:
                        ...
                        try:
                            ...
                            features = gaussian_fitting(emg_data, gaussian_2d, waveform_length, fs=2048, window_ms=25, threshold=0, func_type=False)
                            # 32kmeansクラスタリング
    ...
    # csvファイルに保存
    save_records_to_csv(mucle_activity_informations_kmeans32, out_path='output/test3_waveformlength_gaussianfitting_kmeans32.csv')
    save_records_to_csv(mucle_activity_informations_kmeans42, out_path='output/test3_waveformlength_gaussianfitting_kmeans42.csv')
    save_records_to_csv(mucle_activity_informations_kmeans43, out_path='output/test3_waveformlength_gaussianfitting_kmeans43.csv')
    save_records_to_csv(mucle_activity_informations_kmeans52, out_path='output/test3_waveformlength_gaussianfitting_kmeans52.csv')
    save_records_to_csv(mucle_activity_informations_kmeans53, out_path='output/test3_waveformlength_gaussianfitting_kmeans53.csv')
    save_records_to_csv(mucle_activity_informations_kmeans54, out_path='output/test3_waveformlength_gaussianfitting_kmeans54.csv')
    save_records_to_csv(mucle_activity_informations_normalized_kmeans2, out_path='output/test3_waveformlength_gaussianfitting_normalized_kmeans2.csv')
    save_records_to_csv(mucle_activity_informations_normalized_kmeans3, out_path='output/test3_waveformlength_gaussianfitting_normalized_kmeans3.csv')
    save_records_to_csv(mucle_activity_informations_normalized_kmeans4, out_path='output/test3_waveformlength_gaussianfitting_normalized_kmeans4.csv')
    save_records_to_csv(mucle_activity_informations_normalized_kmeans5, out_path='output/test3_waveformlength_gaussianfitting_normalized_kmeans5.csv')
    save_records_to_csv(mucle_activity_informations_normalized_xmeans, out_path='output/test3_waveformlength_gaussianfitting_xmeans.csv')
    save_records_to_csv(mucle_activity_informations_normalized_xmeans, out_path='output/test3_waveformlength_gaussianfitting_normalized_xmeans.csv')
    save_records_to_csv(mucle_activity_informations_normalized_hdbscan, out_path='output/test3_waveformlength_gaussianfitting_hdbscan.csv')
    save_records_to_csv(mucle_activity_informations_normalized_hdbscan, out_path='output/test3_waveformlength_gaussianfitting_normalized_hdbscan.csv')